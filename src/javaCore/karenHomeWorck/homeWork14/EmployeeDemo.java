package javaCore.karenHomeWorck.homeWork14;


import javaCore.karenHomeWorck.homeWork14.model.Company;
import javaCore.karenHomeWorck.homeWork14.model.Employee;
import javaCore.karenHomeWorck.homeWork14.storage.CompanyStorage;
import javaCore.karenHomeWorck.homeWork14.storage.EmployeeStorage;
import javaCore.karenHomeWorck.homeWork14.util.DateUtil;
...
public class EmployeeDemo implements Commands {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        Company company = new Company("A001", "alex", "Yerevan", "093105453");
        companyStorage.add(company);
        employeeStorage.add(new Employee("Artyom", "Badoyan", "A001", 500, company,
                "Mexanik", new Date(), DateUtil.stringToDate("04/02/2024")));
        employeeStorage.add(new Employee("Karen", "Margaryan", "A002", 300, company,
                "Mexanik", new Date(), DateUtil.stringToDate("10/05/2024")));
        employeeStorage.add(new Employee("Poxos", "Poxosyan", "A003", 800, company,
